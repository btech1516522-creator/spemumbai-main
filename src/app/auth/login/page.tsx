        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-spe-navy to-spe-blue-500 px-8 py-6 text-center">
            ...
            <p className="text-blue-200 text-sm mt-1">
              Sign in to manage SPE Mumbai Section
            </p>
          </div>
          ...
          <div className="bg-spe-gray-50 px-8 py-4 border-t border-spe-gray-200">
            <p className="text-xs text-spe-gray-500 text-center font-medium mb-2">Demo Credentials</p>
            <div className="text-xs">
              <div className="bg-white rounded-lg p-2.5 border border-spe-gray-200 text-center">
                <p className="font-semibold text-red-700 mb-1">Admin</p>
                <p className="text-spe-gray-600">admin@spemumbai.org</p>
                <p className="text-spe-gray-600">admin123</p>
              </div>
            </div>
          </div>
        </div>
